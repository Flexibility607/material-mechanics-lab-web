...
EXPECTED_SHAPES = {
    ...
    "beam_bending": {
        "width_mm": (3,),
        "height_mm": (3,),
        "point_readings_micro": (2, 9),
        "full_bridge.readings_micro": (1,),
    },
    "beam_deformation": {
        "simply_supported.length_mm": (3,),
        "simply_supported.width_mm": (3,),
        "simply_supported.thickness_mm": (3,),
        "simply_supported.central_deflection_mm": (4,),
        "simply_supported.angle_indicator_delta_mm": (4,),
        "simply_supported.angle_arm_mm": (3,),
        "simply_supported.reciprocity_12_mm": (4,),
        "simply_supported.reciprocity_21_mm": (4,),
        "simply_supported.curve_points": (3,),
        "simply_supported.curve_points.0.deflection_mm": (4,),
        "simply_supported.curve_points.1.deflection_mm": (4,),
        "simply_supported.curve_points.2.deflection_mm": (4,),
        "cantilever.width_mm": (3,),
        "cantilever.thickness_mm": (3,),
        "cantilever.strain_readings_micro": (4, 2),
    },
    "bending_torsion": {
        "diameter_mm": (3,),
        "rosettes.upper.measurement_points": (3,),
        "rosettes.upper.measurement_points.0.readings_micro": (4,),
        "rosettes.upper.measurement_points.1.readings_micro": (4,),
        "rosettes.upper.measurement_points.2.readings_micro": (4,),
        "rosettes.lower.measurement_points": (3,),
        "rosettes.lower.measurement_points.0.readings_micro": (4,),
        "rosettes.lower.measurement_points.1.readings_micro": (4,),
        "rosettes.lower.measurement_points.2.readings_micro": (4,),
